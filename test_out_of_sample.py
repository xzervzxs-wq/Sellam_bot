...
DATA_FILE = 'new_test_candles_20days_20251225.csv'
PATTERNS_FILE = 'successful_candles.csv'
TOP_PATTERNS = ['VIVK', 'METC', 'GNL', 'EFA', 'GOGO']

print('=' * 90)
print('🧪 اختبار خارج العينة (Out-of-Sample Test) على 100 سهم جديد (20 يوم)')
print('=' * 90)
...
print(f"🔍 جاري فحص {len(grouped)} يوم تداول لـ 100 سهم جديد...")
...
# Report
print('\n' + '='*80)
print('📊 نتائج الاختبار خارج العينة (Out-of-Sample Results)')
print('='*80)
...
print('\n🏆 أفضل الصفقات في الاختبار الجديد:')
