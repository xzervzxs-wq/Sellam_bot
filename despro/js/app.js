                ...
                ">
                    ...
                    ">
                        <svg width="150" height="40" viewBox="0 0 200 80" style="overflow: visible;">
                            ...
                            <path id="tutorialPathSmall" d="M30,60 Q70,0 120,20 T170,40" 
                                fill="none" 
                                stroke="url(#drawGrad)" 
                                stroke-width="8" 
                            ...
                            <g>
                                <animateMotion dur="2s" repeatCount="indefinite" rotate="0" calcMode="spline" keySplines="0.4 0 0.2 1">
                                    <mpath href="#tutorialPathSmall"/>
                                </animateMotion>
                                <text x="0" y="0" font-size="40" style="transform: translate(-10px, 15px);">✍️</text>
                            </g>
                        </svg>
                    </div>
